  ...
  private initializeSampleData() {
    ...
    const sampleMedicines = [
      ...
      },
      {
        ...
        stock: 80,
        category: "Antibiotic",
        expiryDate: this.getFutureDate(180),
      ...
      },
      {
        ...
        stock: 200,
        category: "Analgesic",
        expiryDate: this.getFutureDate(45),
      ...
      },
      {
        ...
        stock: 300,
        category: "Vitamin",
        expiryDate: this.getFutureDate(730),
      ...
      },
      {
        ...
        stock: 0,
        category: "Analgesic",
        expiryDate: this.getFutureDate(300),
      ...
      },
      {
        ...
        stock: 50,
        category: "Antiseptic",
        expiryDate: this.getPastDate(10),
